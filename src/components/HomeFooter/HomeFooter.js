...
const HomeFooter = () => {
  ...
  useEffect(() => {
    ...
    useEffect(() => { // LinkedIn script started
      // LinkedIn partner ID
      ...
      return () => {
        ...
        const script = document.querySelector('script[src="https://snap.licdn.com/li.lms-analytics/insight.min.js"]');
        if (script) {
          script.remove();
        }
      };
  ...
  return (
    <div className="hfooter-container">
      ...
      <div className='hfooter-icon-logo-wrap'>
        ...
        <Link to='https://www.linkedin.com/company/dlux-tech-corp'><img src={lnkldnicon} alt="lnkldnicon" /></Link>
        <Link to='https://twitter.com/Dlux_Tech'><img src={xicon} alt="xicon" /></Link>
        <Link to='https://www.youtube.com/@DLUXTECH'><img src={utubeicon} alt="utubeicon" /></Link>
        <Link to='https://www.facebook.com/DLUXTech/'><img src={fbicon} alt="fbicon" /></Link>
        <Link to='https://www.instagram.com/dlux_tech/'><img src={instaicon} alt="instaicon" /></Link>        
        </div>
        </div>
...
{/* {showPopup && (
      ...
      <div className='hfooterl2-services_about'>
        <div className="hfooterl2-c1">
         ...
         <Link to='/digital-martech-consulting'> <p>Digital and Martech Consulting</p></Link>
         <Link to='/managed-application-services' ><p>Managed Application Services</p></Link>
         <Link to='/content-management-dam'><p>Content Management and DAM</p></Link>
         <Link to='/training-change-management'><p>Training and Change Management</p></Link>
        </div>

       
        <div className="hfooterl2-c2">
          <Link to='/About-Us'><h3>About us</h3></Link>
          <Link to='/our-growth-story'><p>Our Growth Story</p></Link>
        ...
        <div className="hfooterl2-c3">
          <Link to =''><h3>Platform</h3></Link>
          <Link to ='/adobe-workfront'><p>Adobe Workfront</p></Link>
          <Link to ='/adobe-aem'><p>AEM</p></Link>
          <Link to ='/salesforce'><p>Salesforce</p></Link>
          <Link to ='/aprimo'><p>Aprimo</p></Link>
          <Link to ='/Dataiku'><p>Dataiku</p></Link>
        </div>
