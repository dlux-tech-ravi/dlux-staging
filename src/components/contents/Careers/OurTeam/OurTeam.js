...
//       setTestimonialImage(data.testimonialData.testimonialImage);
//     } catch (error) {
...
//             <img src={secondaryImage.url} alt="Secondary" className="secondary-image" />
//           </div>
...
//             <h1 style={{ fontWeight: "bold" }}>Luxman Pai</h1>
//             <h2>President & CEO</h2>
//             </div>
//             </div>
  ...
  <div className="plays-button-overlay" onClick={handlePlayPause}>
    ▶
  </div>
            )}
           {isPlaying && (
  <div className="pauses-button-overlay" onClick={handlePlayPause}>
    ❚❚
  </div>
      ...
      <div class="boxContainer">
        <img src="https://images.ctfassets.net/pj0maraabon4/2BH6j1KDX1It5wARjzymTC/4aa70b7ee0b765049b22e89c5df3c9ae/Group_771.png" alt="bottomImage3"/>
      </div>
